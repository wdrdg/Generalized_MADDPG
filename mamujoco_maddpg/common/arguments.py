...
def get_args():
    ...
    # Environment
    parser.add_argument("--scenario-name", type=str, default="Swimmer-v2", help="name of the scenario script")
    parser.add_argument("--agent-conf", type=str, default="2x1", help="Determines the partitioning, fixed by n_agents x motors_per_agent")
    parser.add_argument("--agent_obsk", type=int, default=1, help="Determines up to which connection distance k agents will be able to form observations")
    ...
    parser.add_argument("--load-meta", type=int, default=1, help="whether load the meta model_maml")
